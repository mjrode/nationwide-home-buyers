      ...
      <div className="container relative">
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-4">
                        <span className="inline-block px-4 py-2 bg-primary-600/20 text-primary-300 text-xs font-semibold rounded-full">
                          {step.shortDesc}
                        </span>
                      </div>
                    </div>
              ...
              <div key={step.id} className="relative">
                ...
                <div className="relative z-10 text-center group">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-xl md:text-2xl font-bold group-hover:text-primary-300 transition-colors duration-300">
                      {step.title}
                    </h3>
                    ...
                    <div className="pt-4">
                      <span className="inline-block px-6 py-3 bg-white/10 backdrop-blur-sm text-white text-sm font-semibold rounded-full border border-white/20">
                        {step.shortDesc}
                      </span>
                    </div>
                  </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-secondary-300 text-lg">Here's what we've accomplished together</p>
          </div>
            ...
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  <div className={`text-2xl md:text-3xl font-bold ${stat.color} mb-3`}>
                    {stat.value}
                  </div>
